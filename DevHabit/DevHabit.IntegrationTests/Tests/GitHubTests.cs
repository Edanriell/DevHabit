...
public sealed class GitHubTests(DevHabitWebAppFactory factory) : IntegrationTestFixture(factory)
{
    ...
    private static readonly GitHubEventDto TestEvent = new(
        ...
        new GitHubRepositoryDto(
            1,
            "testuser/repo",
            "https://api.github.com/repos/testuser/repo"
        ),
        new GitHubPayloadDto(
            "test-action",
            "refs/heads/main",
            [
                new GitHubCommitDto(
                    "abc123",
                    "Test commit",
                    "https://github.com/testuser/repo/commit/abc123"
                )
            ]
        ),
        true,
    ...
    public async Task GetProfile_ShouldIncludeHateoasLinks_WhenRequested()
    {
        ...
        client.DefaultRequestHeaders.Accept.Add(
            new MediaTypeWithQualityHeaderValue(CustomMediaTypeNames.Application.HateoasJson));
