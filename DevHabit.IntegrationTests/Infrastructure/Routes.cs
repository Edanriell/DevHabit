...
public static class Routes
{
    ...
    public static class EntryImports
    {
        ...
        public static string GetById(string id)
        {
            return $"entries/imports/{id}";
        }
    }

    public static class HabitTags
    {
        public static string UpsertTags(string habitId)
        {
            return $"habits/{habitId}/tags";
        }

        public static string DeleteTag(string habitId, string tagId)
        {
            return $"habits/{habitId}/tags/{tagId}";
        }
    }
}
