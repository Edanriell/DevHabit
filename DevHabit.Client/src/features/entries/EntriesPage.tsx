...
import { EntriesResponse, Entry, EntrySource } from "./types";
...
export const EntriesPage: React.FC = () => {
	...
	const { getEntries, deleteEntry, archiveEntry, unarchiveEntry, isLoading, error } =
		useEntries();
			...
			<div className="flex justify-between items-center">
				...
				<div className="space-x-4">
					<button
						...
						disabled={
							!entriesResponse?.links?.some((link) => link.rel === "create-batch")
						}
					>
